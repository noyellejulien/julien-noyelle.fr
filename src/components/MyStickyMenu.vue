...
const stickyMenuBg = computed(() => {
  return props.burgerIsActive
    ? { top: `${headerHeight.value}px`, height: `${viewHeight.value}px` }
...
<template>
  <div class="nav-header__sticky-menu">
    <div
      class="sticky-menu__background"
      :class="{ hidden: !burgerIsActive }"
      :style="stickyMenuBg"
    ></div>
    <div
      class="sticky-menu__content"
      :class="{ hidden: !burgerIsActive }"
    ...
    >
      <div class="sticky-menu__content__left">
        <div class="sticky-menu__content__left__links">
          <a href="#projects" class="sticky-menu__content__left__links__link">{{
            t("projects")
          }}</a>
          <a href="#about" class="sticky-menu__content__left__links__link">{{
            t("about")
          }}</a>
        </div>
